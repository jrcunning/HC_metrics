...
#### OPTIONAL: ADD CUTOFF DATE
metrics <- metrics %>%
  filter(EventDate <= "2019-06-30")
```
...
# ggplot(pubsumm, aes(x = Year, y = Quantity, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Quantity - 0.5, label = ifelse(Quantity == 0, "", Quantity)), 
...
# ggplot(mediasumm, aes(x = Year, y = Quantity, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Quantity - 0.5, label = ifelse(Quantity == 0, "", Quantity)), 
#             position = "stack", color = "white") +
#   theme_custom() +
...
ggplot(confmeetsumm, aes(x = Quarter, y = Quantity, fill = factor(Year))) +
  ...
  theme_custom() +
  theme(legend.position = "none") +
  labs(x = "", y = "", title = "Number of Presentations", subtitle = "(at conferences or active meetings)")

# ggplot(confmeetsumm, aes(x = Year, y = Quantity, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Quantity - 0.5, label = ifelse(Quantity == 0, "", Quantity)), 
#             position = "stack", color = "white") +
#   theme_custom() +
...
# ggplot(citesumm, aes(x = Year, y = Citations, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Citations - 2, label = ifelse(Citations == 0, "", Citations)), 
#             position = "stack", color = "white") +
#   theme_custom() +
#   labs(x = "")
```
...
# ggplot(citstakesumm, aes(x = Year, y = Quantity, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Quantity - 5, label = ifelse(Quantity == 0, "", Quantity)), 
#             position = "stack", color = "white") +
#   theme_custom() +
#   labs(x = "")
```
...
# ggplot(fdaysumm, aes(x = Year, y = Quantity, fill = forcats::fct_rev(Quarter))) +
#   geom_bar(stat = "identity", alpha = 0.7) +
#   geom_text(aes(y = Quantity - 1, label = ifelse(Quantity == 0, "", Quantity)), 
#             position = "stack", color = "white") +
#   theme_custom() +
